...
void acompanhante(int n)
{
    ...
    {   
        ...
        gotoxy(39,11);scanf("%s",cliente.acompanhante[i].documento);
    }
...
{   
    ...
    if(n==2)
      ...
      gotoxy(57,14);gets(cliente.cartao); 
...
{         
        ...
        gotoxy(14,16);printf("%s",cliente.email);
    ...
    char op;
     ...
     gotoxy(40,3);printf("SISTEMA DE RESERVA");
          ...
          strcpy(cliente.caracteristica.quarto,retorna_quarto(op_quarto,qtd_pessoa_global+qtd_crianca_global));
           ...
           {
               gotoxy(45,22);printf("Seu modelo esta indisponivel");
           }
